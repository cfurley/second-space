...
export const MainLayout: React.FC = () => {
  const [activeNav, setActiveNav] = React.useState('Spaces');
  const [activeSpace, setActiveSpace] = React.useState('My Ideas');
  const [activeFilter, setActiveFilter] = React.useState('Recent');

  return (
    <div className="h-screen bg-[radial-gradient(circle_at_top,_#ffffff_0%_,_#e5e7eb_100%) dark:bg-[radial-gradient(circle_at_bottom,_#0a0a0a_0%,_#1a1a1a_100%)] transition-colors duration-500">
